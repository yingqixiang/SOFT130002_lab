...
<body>
   ...
   //              </a>
	...
	$order=[22,54,7,19,46,6,60,58,75,77,27,2,24,13,101,102];
	foreach($order as $value){
			$keyid=$images[$value]["id"];
			$keypath = $images[$value]["path"];
			$keytitle= $images[$value]["title"];
			echo "<li>";
                 			echo "<a href='detail.php?id=$keyid' class='img-responsive'>";
                 				echo "<img src='images/square/$keypath' alt='$keytitle'>";
